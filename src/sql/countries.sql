...
CREATE TABLE IF NOT EXISTS `craft_countries_DUMP` (
...
--
-- Dumping data for table `craft_countries_DUMP`
--

INSERT INTO `craft_countries_DUMP` (`id_countries`, `name`, `iso_alpha2`, `iso_alpha3`, `iso_numeric`, `currency_code`, `currency_name`, `currrency_symbol`, `flag`) VALUES
...
(239, 'Zimbabwe', 'ZW', '', 263, '', '', '', 'ZW.png'),
(240, 'Hispanoamerica', 'HA', 'HAA', 999, 'USD', 'Dollar', '$', 'HA.png'),
(241, 'South-East Asia', 'EA', 'SEA', 998, 'USD', 'Dollar', '$', 'EA.png');
